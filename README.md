...
Youssef — Personal Portfolio Website
...
Right now the form validates input (name, email, message) but doesn't send anywhere — that needs a backend. The easiest options for a static GitHub Pages site:
